...
Với dữ liệu đầu vào là câu dạng ngôn ngữ tự nhiên, chúng tôi xây dựng 2 công cụ để xác định đặc trưng phủ định trong câu, đặt tên là Meta-NegEx và Gen-NegEx. Trong đó:
\begin{itemize}
