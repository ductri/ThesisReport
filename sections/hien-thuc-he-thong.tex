...
Khi áp dụng Gen-NegEx: kết quả lưu lại dưới dạng XLSX như Bảng~\ref{table:Gen-NegEx}. Trong đó, nội dung \xquote{negated} ở cột \xquote{Result} đánh dấu câu có cấu trúc phủ định. Chi tiết cấu trúc phủ định được ghi rõ ở cột \xquote{Negation}. Từ được đặt trong cờ \xquote{[PREN]} là từ phủ định, từ được đặt trong cờ \xquote{[NEGATED]} là từ bị phủ định, từ được đặt trong cờ \xquote{[CONJ]} là từ dừng báo hiện chấm dứt phạm vi phủ định của từ phủ định.\\
