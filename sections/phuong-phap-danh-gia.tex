...
\hline
\textbf{STT} & \textbf{Đặc trưng} & \textbf{P} & \textbf{R} & \textbf{F} \\ \hline
1 & Kiểm tra trong câu có yếu tố phủ định hay không& 23.45\% & 23.45\% & 23.45\% \\ \hline
2 & Thay các từ phủ định trong câu bằng nhãn NEGATION & 23.45\% & 23.45\% & 23.45\% \\ \hline
3 & Thêm nhãn ``\_NEG'' ngay sau các từ chịu ảnh hưởng phủ định & 23.45\% & 23.45\% & 23.45\% \\ \hline
4 & Kết hợp 1 và 2 & 23.45\% & 23.45\% & 23.45\% \\ \hline
5 & Kết hợp 1 và 3 & 23.45\% & 23.45\% & 23.45\% \\ \hline
6 & Kết hợp 2 và 3 & 23.45\% & 23.45\% & 23.45\% \\ \hline
7 & Kết hợp 1 và 2 và 3 & 23.45\% & 23.45\% & 23.45\% \\ \hline
\end{tabular}
%{\footnotesize \\
%\begin{description}[noitemsep]
%\item[P] Chỉ quan tâm đến việc có xuất hiện hay không n-gram trong câu, nhận 2 giá trị: 1 hoặc 0
