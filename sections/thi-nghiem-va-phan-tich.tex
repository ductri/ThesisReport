...
Vì \term{website} PubMed không chính thức hỗ trợ cung cấp dữ liệu, chúng tôi tự hiện thực công cụ phục vụ nhu cầu này. Chúng tôi sử dụng module \texttt{re} trong Python để gửi các yêu cầu HTTP lên \term{website} PubMed. Khi PubMed trả về phản hồi, thông tin được phân giải và lọc ra phần nội dung cần lấy.\\
